...
def main():
    ...
    print("   6. Note: Browser will auto-close after download completes")
    ...
    print("💡 Tip: The browser will automatically close after the download completes for a cleaner experience.")
